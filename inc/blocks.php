 ...
 * 注册区块样式变体。
 */
function tf_register_block_styles() {
	$styles = array(
		array(
			'block' => 'core/group',
			'name'  => 'card',
		...
		array(
			'block' => 'core/group',
			'name'  => 'bordered',
			'label' => __( '描边框', 'tf-base' ),
		),
		array(
			'block' => 'core/heading',
			'name'  => 'eyebrow',
			'label' => __( '标签行（等宽大写）', 'tf-base' ),
		),
		array(
			'block' => 'core/paragraph',
			'name'  => 'lead',
			'label' => __( '导语（加大）', 'tf-base' ),
		),
		array(
			'block' => 'core/paragraph',
			'name'  => 'spec',
			'label' => __( '规格戳（等宽小字）', 'tf-base' ),
		),
		array(
			'block' => 'core/list',
			'name'  => 'checks',
			'label' => __( '勾选清单', 'tf-base' ),
		),
		array(
			'block' => 'core/image',
			'name'  => 'framed',
...
add_action( 'init', 'tf_register_block_styles' );
 ...
 * 需要放开时把对应项从数组里删掉即可。
 */
function tf_allowed_block_types( $allowed, $context ) {
